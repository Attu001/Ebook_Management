...
<div class="container-fluid p-3">
	...
	<div class="row">
		...
		<c:if test="${not empty userobj}">
					<a class="btn btn-primary"><i class="fa-solid fa-user p-1"></i>${userobj.name}</a>
					 <a data-toggle="modal" data-target="#exampleModalCenter"	class="btn btn-success text-white"><i class="fa-solid fa-right-from-bracket p-1"  ></i>Logout</a>
